...
describe("getPregnancyWeek", () => {
  it("returns week 0 day 0 on the start date", () => {
  ...
  it("returns week 1 day 0 after 7 days", () => {
  ...
  it("returns week 12 day 4 on 22/05/2026 from 23/02/2026", () => {
  ...
  it("returns week 40 day 0 on due date (40 weeks from start)", () => {
  ...
  it("returns week 41 day 0 past due date", () => {
